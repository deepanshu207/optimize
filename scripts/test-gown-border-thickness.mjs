...
assert(contentCode.includes('dataset.staticEditorV = "12"'), "editor panel layout v12");
...
assert(gownCode.includes("gownUsesBorderGradient"), "gown detects border gradient mode");
assert(gownCode.includes("gownBorderFillStyle"), "gown draws gradient outer border");
assert(composeCode.includes("gownUsesBorderGradient"), "compose imports gown gradient helper");
assert(!composeCode.includes('style === "gown_static") return false'), "gown gradient preset enabled");
