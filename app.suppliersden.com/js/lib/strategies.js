...
import { compressStudioToKb, compressFramedToKb } from "./encoder.js?v=29";
import {
  imageToWhiteCanvas,
  trimMargins,
  fitSquare,
  ...
  MEESHO_SQUARE_SIDE,
} from "./canvas-utils.js?v=29";
import { estimateImageShipping } from "./shipping.js?v=29";
import { buildSmartPlan, compareVariants, strategyLabel } from "./smart-plan.js?v=29";
...
export async function optimizeImage(img, options = {}) {
  ...
  // Only filter when user explicitly sets a target AND caller allows it
