...
import { compressStudioToKb, compressFramedToKb } from "./encoder.js?v=25";
import {
  imageToWhiteCanvas,
  trimMargins,
  fitSquare,
  ...
  MEESHO_SQUARE_SIDE,
} from "./canvas-utils.js?v=25";
import { estimateImageShipping } from "./shipping.js?v=25";
import { buildSmartPlan, compareVariants, strategyLabel } from "./smart-plan.js?v=25";
