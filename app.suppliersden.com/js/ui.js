                ...
                <div class="opt-body">
                    ...
                    <div class="opt-section" style="padding:12px;">
                        ...
                        <div style="position:relative;z-index:10000;">
                            <input type="text" id="category-search" class="opt-input" placeholder="🔍 Search by name or ID (e.g. Kurtis or 10004)" style="font-size:16px;padding-right:30px;background:#fff;border-color:#d1d5db;min-height:48px;">
